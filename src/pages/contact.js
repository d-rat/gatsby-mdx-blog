...
function Contact() {
  return (
    <Layout>
      <section className="relative text-gray-900 body-font">
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-col w-full mb-12 text-center">
            ...
            <p className="mx-auto text-base leading-relaxed lg:w-2/3">
              just drop in a message and I'll reach you ASAP!
            </p>
          </div>
            ...
            <div className="flex flex-wrap -m-2">
              <div className="w-1/2 p-2">
                <div className="relative">
                  <label for="name" className="text-sm leading-7 text-gray-800">
                    Name
                  </label>
                  <input
                    type="text"
              ...
              <div className="w-full p-2 pt-8 mt-8 text-center border-t border-gray-200">
                ...
                <span className="inline-flex">
                  <Link
                    to="#"
                    className="text-gray-500 transition duration-300 ease-in-out transform hover:text-black hover:scale-125"
                  >
                    <svg
                      fill="currentColor"
                  ...
                  <Link
                    to="#"
                    className="ml-4 text-gray-500 transition duration-300 ease-in-out transform hover:text-black hover:scale-125"
                  >
                    <svg
                      fill="currentColor"
                      stroke-linecap="round"
